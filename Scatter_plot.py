...
# The scatter uses x and y axies as in a coordinate system.
...
# Because we are using the value 5 as the mean on the x axies, the numbers will be concentrated around that area on the x axies
x = numpy.random.normal(5.0, 1.0, 1000)
# And we use the mean 0 here, which means that they will be centralised around the 10 on the y axies
...
# Also the spread is wider ont he y axies then on the x.